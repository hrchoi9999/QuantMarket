...
from quantmarket_market.macro_event_calendar_daily import build_macro_event_calendar_daily


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build PIT-safe macro event calendar flags for QuantMarket model mart.")
    ...
    parser.add_argument("--report-dir", default=str(ROOT / "reports" / "macro_event_calendar"))
    return parser.parse_args()


def main() -> None:
    args = parse_args()
    result = build_macro_event_calendar_daily(
