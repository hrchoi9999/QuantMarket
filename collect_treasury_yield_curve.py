...
from quantmarket_market.treasury_collector import collect_treasury_yield_curve  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Collect U.S. Treasury daily yield curve data.")
...
def main() -> None:
    ...
    result = collect_treasury_yield_curve(
        db_path=db_path,
    ...
    (report_dir / "treasury_collection_latest.json").write_text(
