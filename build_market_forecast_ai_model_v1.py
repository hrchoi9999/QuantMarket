...
from quantmarket_market.market_forecast_ai_model_v1 import build_market_forecast_ai_model_v1


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train QuantMarket market forecast AI model v1.")
    ...
    parser.add_argument("--feature-columns-json", default=str(current / "market_model_ready_feature_columns_current.json"))
    ...
    parser.add_argument("--report-dir", default=str(ROOT / "reports" / "market_forecast_ai_model_v1"))
    parser.add_argument("--model-dir", default=str(ROOT / "models" / "market_forecast_ai_v1"))
    return parser.parse_args()


def main() -> None:
    args = parse_args()
    result = build_market_forecast_ai_model_v1(
