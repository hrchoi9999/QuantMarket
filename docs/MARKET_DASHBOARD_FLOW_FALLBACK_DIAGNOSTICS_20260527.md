...
|---|---:|---|---:|---:|---:|---:|---:|---:|---:|---|---|---|
| KOSPI | 10d | sideways | 0.366 | 0.450 | 0.084 | 0.028 | 0.434 | 0.464 | 1.026 | defensive_100_30_0 | extra_trees | existing |
| KOSPI200 | 10d | down | 0.338 | 0.450 | 0.112 | 0.004 | 0.434 | 0.019 | 1.058 | moderate_80_40_0 | extra_trees | vol_adjusted_q2020 |
| KOSDAQ | 5d | up | 0.411 | 0.550 | 0.139 | 0.021 | 0.656 | 0.295 | 0.056 | moderate_80_40_0 | ensemble_mean_all | vol_adjusted_wide_q2020 |
| KOSPI | 5d | down | 0.347 | 0.450 | 0.103 | 0.010 | 0.434 | 0.070 | 0.913 | moderate_80_40_0 | extra_trees | vol_adjusted_wide_q2020 |
| KOSPI200 | 5d | sideways | 0.349 | 0.500 | 0.151 | 0.001 | 0.555 | 0.095 | 1.048 | defensive_100_30_0 | extra_trees | vol_adjusted_wide_q2020 |
...
| KOSPI 10d | normal-but-below-floor confidence | Current confidence is near the historical median, but the chosen rule has a high 0.45 floor and 43.4% historical low-confidence ratio. |
...
The remaining fallback rows are not mainly caused by overly strict global thresholds. They are concentrated in short-horizon ambiguity:
...
- KOSPI/KOSPI200 5d may benefit from probability calibration or a separate short-horizon confidence policy.
