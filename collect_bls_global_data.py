...
from quantmarket_market.bls_collector import collect_bls_series  # noqa: E402
from quantmarket_market.global_context_db import DEFAULT_GLOBAL_CONTEXT_DB_PATH  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Collect BLS global macro series.")
...
def main() -> None:
    ...
    (report_dir / "bls_collection_latest.json").write_text(
