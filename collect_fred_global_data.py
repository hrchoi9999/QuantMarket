...
from quantmarket_market.fred_collector import (  # noqa: E402
    DEFAULT_FRED_API_KEY_PATH,
    collect_fred_series,
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Collect FRED global market context series.")
    parser.add_argument("--db-path", default=str(DEFAULT_GLOBAL_CONTEXT_DB_PATH))
    parser.add_argument("--api-key-path", default=str(DEFAULT_FRED_API_KEY_PATH))
    ...
    parser.add_argument("--series", nargs="*", default=None, help="Optional FRED series IDs to collect.")
...
def main() -> None:
    ...
    (report_dir / "fred_collection_latest.json").write_text(
