...
schtasks /Create /F /TN $TaskName /SC WEEKLY /D MON,TUE,WED,THU,FRI /ST 20:00 /RI 10 /DU 10:00 /TR $taskCmd
Write-Host "Registered task: $TaskName"
Write-Host "Command: $taskCmd"
Write-Host "Schedule: MON-FRI 20:00~06:00 KST, every 10 minutes"
