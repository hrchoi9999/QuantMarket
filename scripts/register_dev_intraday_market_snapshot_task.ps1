...
schtasks /Create /F /TN $TaskName /SC WEEKLY /D MON,TUE,WED,THU,FRI /ST 09:00 /RI 10 /DU 06:40 /TR $taskCmd
Write-Host "Registered task: $TaskName"
Write-Host "Command: $taskCmd"
Write-Host "Schedule: MON-FRI 09:00~15:40 KST, every 10 minutes"
